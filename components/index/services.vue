  ...
  <app-container>
    <div class="text-section">
      <div class="service">
        ...
        <p>Для привлечения инвесторов и покупателей предлагаем концептуально новый подход.</p>
        <p>
          Подчеркнем уникальность вашего проекта профессиональными анимациями, создадим необходимое
          настроение с помощью {качественных} видеороликов. Для нас нет ограничений, при
          необходимости, создадим короткометражный фильм со своим сценарием и живыми актерами, еще
          на этапе разработки объекта.
        </p>
        <p>Сделаем ваш проект максимально привлекательным для покупателя как можно раньше.</p>
        <!--        <p>-->
